    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      justify-between max-sm:flex:col-reverse rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <textarea onChange={(e)=>setBio(e.target.value)} value={bio} placeholder='Set a bio...' required className='p-2 border border-gray-500 
        ...
        <img 
          ...
          alt="" 
          className={`w-44 h-auto object-contain mx-10 max-sm:mt-10 ${selectedImg && 'rounded-full'}`}
